...
import { MAX_FIELDS } from "./layout.js";
...
// The most metric fields the app will draw. Owned by lib/layout.js (it is a
// layout limit); re-exported here as MAX_ROWS for the settings/config code.
export const MAX_ROWS = MAX_FIELDS;
